    ...
    public function run(): void
    {
        ...
        $products = [
            [
                ...
                'image_url' => 'https://loremflickr.com/1200/800/industrial,sausage,stuffer?lock=101',
                'available' => true,
            ...
            [
                ...
                'image_url' => 'https://loremflickr.com/1200/800/meat,slicer,industrial?lock=104',
                'available' => true,
                'tags' => ['corte', 'cárnico'],
            ],
            [
                ...
                'image_url' => 'https://loremflickr.com/1200/800/sausage,clipper,machine?lock=105',
                'available' => true,
            ...
            [
                ...
                'image_url' => 'https://loremflickr.com/1200/800/food,stuffer,machine?lock=106',
                'available' => true,
                'capacity' => '30 L',
                'tags' => ['embutidos', 'pyme'],
            ],
            [
                ...
                'image_url' => 'https://loremflickr.com/1200/800/piston,stuffer,industrial?lock=107',
                'available' => true,
                'capacity' => '400 kg/h',
                'power' => '750 W',
            ...
            [
                ...
                'image_url' => 'https://loremflickr.com/1200/800/sausage,casing,food?lock=116',
                'available' => true,
